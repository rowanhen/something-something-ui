import{j as u,a as n}from"./jsx-runtime-2162d874.js";import{u as t,a as s}from"./styled-components.browser.esm-14148d23.js";import"./Accordian-3e8e99ea.js";import"./Ascii-30d57583.js";import"./Badge-d931c89c.js";import"./Banner-594646c0.js";import"./Card-07d02d2c.js";import"./Checkbox-2c0839d0.js";import"./Chip-ac0743d4.js";import"./Container-2d7d5aaf.js";import{r as m}from"./index-c6dae603.js";import"./Divider-8e72693e.js";import{r as B}from"./index-eb008d06.js";import{F as N}from"./Field-b9360730.js";import"./Icon-bc54a877.js";import"./Info-639d9cc6.js";import"./Link-3c547324.js";import{L as S}from"./Loader-073627a0.js";import"./Menu-18af8f1f.js";import"./Popover-b7c4b040.js";import"./Radio-0cb6dd05.js";import"./Row-0ad75d8f.js";import"./TabList-77255eb7.js";import"./Text-6f869e24.js";import"./Textarea-af6c11b7.js";import"./Toggle-a6e8a904.js";import"./Tooltip-dab542f2.js";import{c as b}from"./theme-860d7b96.js";const _=({open:e,handleClose:i,title:o,closeButton:c,children:a,width:r,primaryButton:l,secondaryButton:d})=>{const p=m.useRef(null);return m.useEffect(()=>{p.current&&(e?typeof p.current.showModal=="function"?p.current.showModal():console.warn("The showModal() method is not supported by this browser."):p.current.close())},[e]),u(j,{ref:p,width:r,children:[u(z,{children:[n("h2",{children:o}),c&&n(L,{onClick:i,children:"X"})]}),n(R,{children:a}),u(F,{children:[d&&n(O,{onClick:d.onClick,fullLength:!!l,children:d.label}),l&&n(M,{onClick:l.onClick,fullLength:!!d,children:l.label})]})]})},j=t.dialog(({width:e})=>s`
    min-width: 300px;
...
`,M=t(f)(({fullLength:e})=>s`
  ...
  `),O=t(f)(({fullLength:e})=>s`
    ...
    `}
    min-width: 120px;
  `);try{_.displayName="Dialog",_.__docgenInfo={description:"",displayName:"Dialog",props:{open:{defaultValue:null,description:"",name:"open",required:!0,type:{name:"boolean"}},handleClose:{defaultValue:null,description:"",name:"handleClose",required:!0,type:{name:"() => void"}},title:{defaultValue:null,description:"",name:"title",required:!0,type:{name:"string"}},closeButton:{defaultValue:null,description:"",name:"closeButton",required:!0,type:{name:"boolean"}},width:{defaultValue:null,description:"",name:"width",required:!1,type:{name:"string"}},primaryButton:{defaultValue:null,description:"",name:"primaryButton",required:!1,type:{name:"{ label: string; onClick: () => void; }"}},secondaryButton:{defaultValue:null,description:"",name:"secondaryButton",required:!1,type:{name:"{ label: string; onClick: () => void; }"}}}}}catch{}const D=m.createContext({portalRoot:null}),w=({children:e})=>{const i=document.getElementById("portal-root")||document.createElement("div");return document.getElementById("portal-root")||(i.id="portal-root",document.body.appendChild(i)),n(D.Provider,{value:{portalRoot:i},children:e})},I=()=>{const e=m.useContext(D);if(!e)throw new Error("usePortal must be used within a PortalProvider");return e};try{w.displayName="PortalProvider",w.__docgenInfo={description:"",displayName:"PortalProvider",props:{}}}catch{}const C=({open:e,handleClose:i,title:o,closeButton:c,primaryButton:a,secondaryButton:r,width:l,closeOnOutsideClick:d=!0,children:p})=>{const{portalRoot:h}=I(),y=m.useRef(null),g=v=>{y.current&&!y.current.contains(v.target)&&d&&i()};if(m.useEffect(()=>(document.addEventListener("mousedown",g),()=>{document.removeEventListener("mousedown",g)}),[]),m.useEffect(()=>{},[e]),!h)return null;const x=n(X,{ref:y,open:e,width:l,children:u(Y,{children:[u(H,{children:[o&&n(U,{children:o}),c&&n(W,{onClick:i,children:"X"})]}),n(A,{children:p}),u(G,{children:[r&&n(q,{onClick:r.onClick,children:r.label}),a&&n(q,{onClick:a.onClick,children:a.label})]})]})});return B.createPortal(x,h)},X=t.div`
  position: fixed;
  top: 0;
...
`,q=t.button`
  flex-grow: 1;
`;try{C.displayName="Drawer",C.__docgenInfo={description:"",displayName:"Drawer",props:{open:{defaultValue:null,description:"",name:"open",required:!0,type:{name:"boolean"}},handleClose:{defaultValue:null,description:"",name:"handleClose",required:!0,type:{name:"() => void"}},title:{defaultValue:null,description:"",name:"title",required:!1,type:{name:"string"}},closeButton:{defaultValue:null,description:"",name:"closeButton",required:!1,type:{name:"boolean"}},primaryButton:{defaultValue:null,description:"",name:"primaryButton",required:!1,type:{name:"{ label: string; onClick: () => void; }"}},secondaryButton:{defaultValue:null,description:"",name:"secondaryButton",required:!1,type:{name:"{ label: string; onClick: () => void; }"}},width:{defaultValue:null,description:"",name:"width",required:!1,type:{name:"string"}},closeOnOutsideClick:{defaultValue:{value:"true"},description:"",name:"closeOnOutsideClick",required:!1,type:{name:"boolean"}}}}}catch{}const V=({label:e,assistiveText:i,requiredMessage:o,prefix:c,suffix:a,options:r,...l})=>n(N,{label:e,assistiveText:i,requiredMessage:o,id:l.id,children:u(J,{children:[c&&n(K,{children:c}),n(Z,{...l,children:r.map(d=>n("option",{value:d.value,children:d.label},d.value))}),a&&n(Q,{children:a})]})}),J=t.div`
  display: flex;
  align-items: center;
`,K=t.span`
  margin-right: 8px;
...
`,re=t.input`
  flex: 1;
  padding: 8px;
`;try{k.displayName="Input",k.__docgenInfo={description:"",displayName:"Input",props:{label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string"}},assistiveText:{defaultValue:null,description:"",name:"assistiveText",required:!1,type:{name:"string"}},requiredMessage:{defaultValue:null,description:"",name:"requiredMessage",required:!1,type:{name:"string"}},prefix:{defaultValue:null,description:"",name:"prefix",required:!1,type:{name:"string"}},suffix:{defaultValue:null,description:"",name:"suffix",required:!1,type:{name:"string"}}}}}catch{}const E=m.createContext(void 0),$=({children:e})=>{const[i,o]=m.useState([]),c=(r,l)=>{o(d=>[...d.slice(-2),{id:l,content:r}])},a=r=>{o(l=>l.filter(d=>d.id!==r))};return u(E.Provider,{value:{addToast:c,removeToast:a},children:[e,i.map(r=>r.content)]})},ie=()=>{const e=m.useContext(E);if(!e)throw new Error("useToast must be used within a ToastProvider");return e};try{$.displayName="ToastProvider",$.__docgenInfo={description:"",displayName:"ToastProvider",props:{}}}catch{}const T=({id:e,title:i,open:o,handleClose:c,closeButton:a,primaryButton:r,secondaryButton:l,width:d,autoClose:p=6,position:h})=>{const{portalRoot:y}=I(),{removeToast:g}=ie();if(m.useEffect(()=>{if(p){const v=setTimeout(()=>{g(e)},p*1e3);return()=>clearTimeout(v)}},[p,c,e,g]),!y||!o)return null;const x=n(oe,{width:d,position:h,open:o,children:u(ae,{children:[u(le,{children:[i&&n(se,{children:i}),a&&n(de,{onClick:()=>g(e),children:"X"})]}),u(ce,{children:[l&&n(P,{onClick:l.onClick,children:l.label}),r&&n(P,{onClick:r.onClick,children:r.label})]})]})});return B.createPortal(x,y)},oe=t.div`
  position: fixed;
  width: ${e=>e.width||"300px"};
  padding: 12px;
...
`;try{T.displayName="Toast",T.__docgenInfo={description:"",displayName:"Toast",props:{id:{defaultValue:null,description:"",name:"id",required:!0,type:{name:"string"}},title:{defaultValue:null,description:"",name:"title",required:!0,type:{name:"string"}},open:{defaultValue:null,description:"",name:"open",required:!0,type:{name:"boolean"}},closeButton:{defaultValue:null,description:"",name:"closeButton",required:!1,type:{name:"boolean"}},handleClose:{defaultValue:null,description:"",name:"handleClose",required:!1,type:{name:"(() => void)"}},primaryButton:{defaultValue:null,description:"",name:"primaryButton",required:!1,type:{name:"{ label: string; onClick: () => void; }"}},secondaryButton:{defaultValue:null,description:"",name:"secondaryButton",required:!1,type:{name:"{ label: string; onClick: () => void; }"}},width:{defaultValue:null,description:"",name:"width",required:!1,type:{name:"string"}},autoClose:{defaultValue:{value:"6"},description:"",name:"autoClose",required:!1,type:{name:"number"}},position:{defaultValue:null,description:"",name:"position",required:!0,type:{name:"enum",value:[{value:'"bottom-left"'},{value:'"bottom-center"'},{value:'"bottom-right"'},{value:'"top-left"'},{value:'"top-center"'},{value:'"top-right"'}]}}}}}catch{}const ue={small:s`
  ...
  `,large:s`
    padding: 10px 24px;
    font-size: 1.2rem;
  `},f=({active:e,disabled:i,loading:o,size:c="small",children:a,...r})=>u(fe,{...r,active:e,disabled:i,loading:o,size:c,children:[o&&n(pe,{children:n(S,{size:16})}),n(me,{loading:o,children:a})]}),pe=t.div`
  position: absolute;
  display: flex;
  align-items: center;
