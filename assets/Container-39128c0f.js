...
`,c=n.h4`
  ${({labelX:e,labelY:a})=>t`
    ...
    `}
  `}
`;try{l.displayName="Container",l.__docgenInfo={description:"",displayName:"Container",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},label:{defaultValue:null,description:"",name:"label",required:!1,type:{name:"string"}},labelX:{defaultValue:{value:"center"},description:"",name:"labelX",required:!1,type:{name:"enum",value:[{value:'"left"'},{value:'"right"'},{value:'"center"'}]}},labelY:{defaultValue:{value:"top"},description:"",name:"labelY",required:!1,type:{name:"enum",value:[{value:'"top"'},{value:'"bottom"'}]}}}}}catch{}export{l as C};
